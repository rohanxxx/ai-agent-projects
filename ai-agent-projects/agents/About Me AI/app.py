...
class Me:
    ...
    def __init__(self):
        ...
        #gets the pdf file as all the pages object
        reader = PdfReader("me/Profile.pdf")
        #gets each pages
        for page in reader.pages:
            #extract each pages text
...
particularly questions related to {self.name}'s career and myself, background, skills and experience. \
